...
public class SceneGUI : MonoBehaviour
{
    ...
    void OnGUI ()
    {
        ...
        if (!hub.hubInitialized) {
            ...
            GUI.Label (new Rect (12,10, Screen.width, Screen.height),
                "Fist: Shoot\n" +
                "Wave in: Cycle down through weapons list\n" +
                "Wave out: Cycle up through weapons list\n" +
                "Double tap: Throw a Grenade\n" +
                "Fingers spread: Shoot continuously"
            );
        }
    }
